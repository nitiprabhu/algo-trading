...
async def main():
    ...
    # Enable AI for this backtest
    runtime.signal_engine.ai_enabled = True
    ...
    print(f"\n{'='*70}")
    print(f"🚀 INITIALIZING {DATE_STR} BACKTEST (WITH AI)")
    print(f"{'='*70}")
    ...
    print(f"\n{'='*70}")
    print(f"📊 PERFORMANCE METRICS FOR {DATE_STR} (WITH AI)")
    print(f"{'='*70}")
