...
async def main():
    ...
    # Disable AI signal review for trades, so we use pure rule-based confluence,
    # but the AI Regime Agent will run once to decide the baseline threshold dynamically.
    ...
    print(f"\n{'='*70}")
    print(f"🚀 INITIALIZING {DATE_STR} BACKTEST WITH DYNAMIC AI REGIME AGENT")
    print(f"{'='*70}")
    ...
    print(f"🧠 AI Regime Agent: ACTIVE")
    print(f"{'='*70}\n")
    ...
    print(f"\n{'='*70}")
    print(f"📊 PERFORMANCE METRICS FOR {DATE_STR} (DYNAMIC THRESHOLD)")
    print(f"{'='*70}")
