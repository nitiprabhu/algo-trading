...
async def main():
    dec_start = datetime(2025, 12, 1, tzinfo=IST)
    dec_end = datetime(2025, 12, 31, 15, 30, tzinfo=IST)
    
    res = await run_backtest_for_range(dec_start, dec_end)
    
    msg = (
        "📊 *Backtest Performance Report*\n"
        "_(Regime Agent: ON | AI Review: OFF)_\n\n"
        "*📅 December 2025 Range (01 Dec - 31 Dec):*\n"
