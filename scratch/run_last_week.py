...
async def main():
    ...
    # Last week: June 22 to June 26, 2026
    start_date = datetime(2026, 6, 22, tzinfo=IST)
    end_date = datetime(2026, 6, 26, tzinfo=IST)
    
    current_date = start_date.date()
    delta_day = timedelta(days=1)
    
    print("\n" + "="*60)
    print("📊 LAST WEEK PERFORMANCE BREAKDOWN (Jun 22 - Jun 26, 2026)")
    print("="*60)
