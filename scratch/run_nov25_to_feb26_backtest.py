...
async def main():
    months = [
        ("November 2025", datetime(2025, 11, 1, tzinfo=IST), datetime(2025, 11, 30, 15, 30, tzinfo=IST)),
        ("December 2025", datetime(2025, 12, 1, tzinfo=IST), datetime(2025, 12, 31, 15, 30, tzinfo=IST)),
        ("January 2026",  datetime(2026, 1, 1, tzinfo=IST), datetime(2026, 1, 31, 15, 30, tzinfo=IST)),
        ("February 2026", datetime(2026, 2, 1, tzinfo=IST), datetime(2026, 2, 28, 15, 30, tzinfo=IST)),
    ]

    print("\n" + "="*70)
    print("  RUNNING BACKTESTS: NOV 2025 - FEB 2026 (WITH DATA INTEGRITY CHECKS)")
    print("="*70)
    ...
    # Format message
    msg = "📊 *Nov 2025 - Feb 2026 Backtest Performance Report*\n\n"
    ...
    if stopped_at:
        ...
        msg += "✅ All requested backtests (Nov 2025 - Feb 2026) completed successfully!"
